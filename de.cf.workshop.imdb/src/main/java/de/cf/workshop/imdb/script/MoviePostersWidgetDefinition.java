...
import de.cf.workshop.imdb.handler.moviePosters.LoadMoviesHandler;

public class MoviePostersWidgetDefinition extends WidgetDefinition {

    public static final String KIND = "de.cf.workshop.imdb.moviePosters";
    ...
    public WidgetSubstitution getContentSubstitution(WidgetConfiguration conf, WidgetSubstitutionParameters params) {
        return new WidgetTemplateSubstitution() {
            ...
            protected void init() {
                ...
                state.loadMoviesUrl = Forwarder.getFullUrl(LoadMoviesHandler.class, embeddedIn);
            }
